...
class MPU9250
{
  ...
  public:
    ...
    void getGres();
    void getAres();
    void readAccelData(int16_t *, uint8_t);
    void readGyroData(int16_t *, uint8_t);
    void readMagData(int16_t *);
    int16_t readTempData(uint8_t);
    void updateTime();
    void initAK8963(float *);
    void initMPU9250(uint8_t);
    void calibrateMPU9250(float * gyroBias, float * accelBias, uint8_t);
    void MPU9250SelfTest(float * destination, uint8_t);
